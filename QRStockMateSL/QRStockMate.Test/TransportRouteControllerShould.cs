...
namespace QRStockMate.Test {
	public class TransportRouteControllerShould {
		...
		// Otros tests similares para cubrir otros casos de �xito y de error en el m�todo CreateTransportRoute
		...
		// Otros tests similares para cubrir otros casos de �xito y de error en el m�todo UpdateTransportRoute
		...
		// Otros tests similares para cubrir otros casos de �xito y de error en el m�todo GetTransportRouteById
		...
		// Otros tests similares para cubrir otros casos de �xito y de error en el m�todo InitRoute
